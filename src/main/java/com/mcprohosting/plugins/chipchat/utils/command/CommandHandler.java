...
public class CommandHandler {
     ...
     *
     * @param obj The object to register the command of
     */
    ...
    public void registerHelp() {
        ...
        IndexHelpTopic topic = new IndexHelpTopic(plugin.getName(), "All command for " + plugin.getName(), null, help,
                "Below is a list of all " + plugin.getName() + " command:");
